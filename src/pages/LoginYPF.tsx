...
export const LoginYPF = () => {
  ...
  return (
    <div className="h-screen w-full bg-[url('./assets/banner-1.jpg')] bg-cover bg-center flex items-center justify-center">
      <div className=" bg-custom-blue w-1/4 flex items-center flex-col h-auto rounded-xl shadow-lg ">
